class GroupController < ApplicationController
  ...
  def list
    ...
    if params[:all] == 'true'
      ...
      @group = Group.all :conditions => ["enddate > ? and expected_number > 0", Date.today]
      @showall = false
    end
  ...
  def show_campers_in_group
    ####################################################
    # List all campers for a particular group
    ####################################################
    campers = []
    group = Group.find params[:group_id].to_i
  ...
  def show_reservations_in_group
    ####################################################
    # List all reservations in a particular group
