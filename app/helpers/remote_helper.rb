...
module RemoteHelper
  ...
  def get_header_days
    ...
    date = @startDate 
    first_closed = true
    ret_str = '<div id="lockedHeadDay" style="overflow: hidden"><div id="flexDiv" style="overflow:auto;display:flex"><div class="av_date header-th" id="stickyTh" style="border:1px solid white;background:#666666;"></div>'
