module Report::PaymentsHelper
  ...
  def output_subtotal
    str = "<td></td> <td></td> <td></td><td align=\"right\"><b>#{number_2_currency(@net_sub)}</b></td>"
  ...
  def total(tot = 0.0, net = 0.0, tax = 0.0)
      str = "<td><b>Total</b></td><td></td><td></td><td></td><td></td><td align=\"right\"><b>#{number_2_currency(net)}</b></td> <td align=\"right\"><b>#{number_2_currency(tax)}</b></td> <td align=\"right\"><b>#{ number_2_currency(tot) }</b></td>"
  end
end
