class Archive < ActiveRecord::Base
  ...
  def self.archive_record(res)
	...
	a.country = res.camper.country_id? ? res.camper.country.name : ''
      end
      a.adults = res.adults
      a.pets = res.pets
      a.kids = res.kids
      ...
      # get payments
      pmt_array = []
      payments = Payment.find_all_by_reservation_id(res.id)
	...
	date = DateFmt.format_date pmt.created_at.to_date
