...
ActiveRecord::Schema.define(:version => 87) do
  ...
  create_table "options", :force => true do |t|
    ...
    t.string  "res_list_sort",                                                           :default => "unconfirmed_remote desc, startdate, group_id, spaces.position as"
    t.string  "inpark_list_sort",                                                        :default => "unconfirmed_remote desc, enddate, startdate, group_id, spaces.po"
