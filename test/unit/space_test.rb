...
class SpaceTest < ActiveSupport::TestCase
  ...
  def test_01
    ...
    assert_equal 3, s.nitems
  end
  def test_01a
    s=Space.available Date.today, Date.today+2, 1
    assert_equal 2, s.nitems
  end
  def test_01b
  ...
  def test_03b
    ...
    assert_equal 0, s.nitems
  end

  def test_04
    # get all spaces
    s=Space.available Date.today, Date.today+1
    assert_equal 15, s.nitems
  end
